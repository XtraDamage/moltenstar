...
export function getSettings() {
  ...
  try {
    ...
    return {
      ...
      colorScheme: parsed.colorScheme || 'molten',
      multiAgentEnabled: parsed.multiAgentEnabled !== undefined ? parsed.multiAgentEnabled : true,
      agents: parsed.agents || DEFAULT_AGENTS
    };
  } catch {
    return { theme: 'auto', colorScheme: 'molten', multiAgentEnabled: true, agents: DEFAULT_AGENTS };
  }
}
